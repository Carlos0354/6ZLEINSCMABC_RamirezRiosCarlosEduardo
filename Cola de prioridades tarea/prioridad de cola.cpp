...
double saldo(double total)
{
    cout<<endl;
    if (total==0)
        cout<<"No tiene saldo en su cuenta"<<endl<<endl;
    else
...
void fin()
{
    cout<<endl<<"Gracias:3 vuelva pronto"<<endl<<endl;
}
...
double retiro(double total)
{
    ...
    cout<<endl;
    if(total==0)
        cout<<"No tiene saldo que pueda retirar"<<endl;
    else
    do
    {
...
int menu(double total)
{
    int opcion;
    cout<<" MENU "<<endl;
    cout<<"tarjetaambiente"<<endl;
    cout<<"cuenta vip"<<endl;
...
double proceso(int opcion,double total) 
{
    switch (opcion)
    {
        ...
        case 4:cout<<endl<<"Ha salido del sistema"<<endl<<endl;exit (0); 
        default: {
...
int main()
{
    ...
    do
    {
        ...
        {
        cout<<endl;
        cout<<"Desea realizar alguna otra transaccion (Si) (No): ";
        cin>>c;
        a=0;
        switch(c)
        {
